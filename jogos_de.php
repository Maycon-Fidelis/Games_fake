...
<body>
    ...
    <header class="header">
        ...
        <div class="header_right">
            <a href="loja_de_jogos_suporte.html" class="suporte">Suporte <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
            ...
            <a href="Tela_de_login.html" class="entrar">Entrar<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
            ...
            <a href="Loja_de_jogos_carrinho.html" class="carrinho">Carrinho <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
        ...
        <div class="todos-os-jogos-block">
            ...
            if ($result->num_rows > 0) {
                while ($linha = $result->fetch_assoc()) { 
                    if(stripos($linha["plataformas"], $plataforma) !== false){
                        $nome_jogo_link = str_replace(' ', '-', $linha['nome_do_jogo']);
                        echo '<a href="pagina_de_jogo.php?' . $linha['id_jogo'] . '?' . $nome_jogo_link . '">';
