...
<head>
    ...
    <link rel="stylesheet" href="CSS\editar_jogos.css">
        ...
        <div class="todos-os-jogos-block">
            ...
            if ($result->num_rows > 0) {
                while ($linha = $result->fetch_assoc()) {   
                    ...
                    echo '<div class="icone_plataformas">';
                    ...
                    echo '</div>';
                    echo '</div>';
                    echo '<div id="editar_jogo"><a href="editar_jogo_form.php?id=' . $linha['id_jogo'] . '">Editar Jogo</a></div>';
                        echo '</div>';
                    echo '</div>';
                }
            }
